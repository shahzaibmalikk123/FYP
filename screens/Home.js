...
import { View,Text,SafeAreaView,Pressable,Image,FlatList,StyleSheet,ImageBackground,useState,ScrollView} from 'react-native';
...
export const Home=({navigation})=>{
            ...
            <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <View style={{height:"80%",
                              ...
                              borderRadius:SIZES.radius
                                ...
                                <Text style={{color:'teal',fontSize:SIZES.h4,fontWeight:'bold'}}>Welcome to MedxCure</Text>
    ...
    function renderMedPic(){
        return(
            <View style={{width:'100%',height:"30%",justifyContent:'center',flexDirection:'column',alignContent:"center",paddingTop:0}}>
                
                <Pressable style={{padding:SIZES.padding*2,paddingBottom:0}}>
                    
                    <Image
                        style={{width:"100%",height:"90%",borderRadius:30,backgroundColor:'teal'}}
                        resizeMode='cover'
                        
                        source={images.booknow}/>
                    
                </Pressable>
                <View style={{position:'absolute',width:'40%',height:'50%',left:60,bottom:60,top:40,flexWrap:'wrap',}}>
                    <View style={{padding:SIZES.padding*0,flexDirection:'column'}}>
                            <Text style={{fontWeight:'800', fontSize:SIZES.h5,color:'teal',paddingBottom:10}}>
                                How to Save your life from COVID-19
                            </Text>
                            <Pressable style={{height:"45%",backgroundColor: "#F0846D",justifyContent:'center',alignItems:'center',width:'70%',padding:10,borderRadius:30}}>
                                <Text style={{fontWeight:'bold',color:'white'}}>Read More</Text>
                            </Pressable>
    ...
    function renderMainCategories(){
        const renderItem =({item}) =>{
            return(
                ...
                <Pressable style={{
                    padding:SIZES.padding*0.5,marginTop:10,
                    paddingLeft:SIZES.padding*0.5,
                    flex:1,
                    justifyContent:'center',
                    //backgroundColor:(selectedCategory?.id == item.id) ? COLORS.teel : COLORS.lightGray,
                    backgroundColor:(selectedCategory?.id == item.id) ? "#22BFB4" : COLORS.lightGray,
                    borderRadius:20,
                    alignItems:'center',
                    //justifyContent:'center',
                ...
                >
                    ...
                    <View style={{justifyContent:'center',alignItems:'center',width:80,padding:0,}}>
                        <Text 
                        numberOfLines={1}
                        style={{  
                            color:COLORS.black,
        ...
        return(
                ...
                <View style={{padding:SIZES.padding*2,paddingTop:0,paddingBottom:0,justifyContent:'center',alignItems:'center',height:'28%'}}>
                    ...
                    <FlatList
                        ...
                        contentContainerStyle={{paddingVertical : SIZES.padding * 1.5,paddingTop:0}}
                    />
                    <View style={{
                        ...
                        <View style={{flex:1,alignItems:'flex-start'}}>
                            <Text style={{fontWeight:'bold',fontSize:SIZES.h4}}>New Medicines</Text>
                            
                        </View>
                        <Pressable style={{alignItems:'flex-end'}}>
                            <Text style={{fontWeight:'bold',fontSize:SIZES.h5,color:"#B9B9B9"}}>
                            See all
                            </Text>
                        </Pressable>
    ...
    function renderMedicines(){
        ...
        return(
            <ScrollView>
            <View style={{width:'100%',flexDirection:'row',flexWrap:'wrap',paddingBottom:SIZES.padding*4,backgroundColor:COLORS.lightGray,borderTopRightRadius:35,borderTopLeftRadius:35}}>
            {
                medicines.map((item,index)=>{
                  return(
                   <View key={item.id} 
                         style={{width:"50%",padding:SIZES.padding*2,borderRadius:SIZES.radius,paddingBottom:5}}>
                  <Pressable
                     onPress={()=> navigation.navigate("OrderDelivery",{
                        item
                        
                    })}
                     style={{flex:1,backgroundColor:"white",borderRadius:SIZES.radius}}>
                  ...
                  <View style={{height:50,justifyContent:'center',alignItems:"center",width:'100%',}}>
                    <Text numberOfLines={1}
                     style={{paddingBottom:0,fontWeight:'bold'}}>{item.name}</Text>
                  </View>
                  </View>
