...
const slides = [
    {
        ...
        description:
            '"Our website offers some of the very best prices on medicines and pharmaceutical products, together with a fantastic service"',
    ...
    },
    {
        ...
        title: "Health Care",
        description:
            '" Pharmacists are the health care team member with the most complete drug therapy knowledge, and they are prepared to use that information"',
    ...
    },
    {
        ...
        description:
            '"Order Medicine and get delivery in the fastest time in the town "',
