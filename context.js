...
import { View,Text,SafeAreaView,Pressable,Image,FlatList,StyleSheet,ImageBackground,ScrollView} from 'react-native';
...
const PracticeProvider =({children})=>{
    ...
    const [medicineData,setMedicine] = React.useState(
    ...
    return(
        <ContextP.Provider value={{medicineData,setMedicine,buyData,setBuyData}}>
         {children}
        </ContextP.Provider>
     );
}
export {PracticeProvider,ContextP};
